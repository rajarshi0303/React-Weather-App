...
export default function Timing({ sunrise, sunset, timezone }) {
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="overflow-hidden rounded  py-4">
            <div className="flex items-end">
              ...
              <div className="px-4">
                <h4 className=" text-gray-300 font-semibold text-base mb-1">
                  Sunrise
                </h4>
          ...
          <div className="overflow-hidden rounded  py-4">
            <div className="flex items-end">
              <svg
                className="w-6 h-6 sm:w-11 sm:h-11 text-gray-300"
                viewBox="0 0 24 24"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
